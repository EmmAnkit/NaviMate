...
General Practitioners Page (search)![screen](assets/images/16.png)|Users can search doctors too.This picture should be with 15
Doctor Page![screen](assets/images/17.png)|After finding their preferable doctors, users can learn more on this page which provides multiple great features.
Doctor Page (number)![screen](assets/images/18.png)|On the Doctor's Page we can click on the number which will transfer us to make a call or click on “More information” which will open the website of the doctor. 
Doctor Page (website)![screen](assets/images/19.png)|This picture should be with 18
Doctor Page (map)![screen](assets/images/20.png)|If the user scrolls down a bit, we will be able to see a map where the doctor is located. Also, the red pin is clickable which opens up location in google maps application.
Doctor Page (actual map)![screen](assets/images/21.png)|This picture should be with 20
Doctor Page (comment)![screen](assets/images/22.png)|Users can also like and leave comments about the doctor.
Doctor Page (like)![screen](assets/images/23.png)|This picture should be with 22
Write a Review Page![screen](assets/images/24.png)|For the user to write a review, they need to click on write a review on Doctor’s Page and Write a Review page will open up. Users can use anonymous to publish their review anonymously. Write their review in the field and click on the “Publish Review” button.
Write a Review Page (written)![screen](assets/images/25.png)|This picture should be with 24
Doctor Page (new review)![screen](assets/images/26.png)|This picture should be with 24
Hospital Description Page ![screen](assets/images/27.png)|There is the same structure for the hospitals and specialist doctors too. Additionally, if it was provided, there is an email which users can use to email the facility. By clicking on the email, the user will be redirected to the mailing platform of their choice.
Hospital Description Page (email)![screen](assets/images/28.png)|This picture should be with 27
Specialists Page![screen](assets/images/29.png)|General Practitioners and Hospitals have similar starting page, however before users start looking for specialists, there is one more page. On this page, the user can choose which specialist they need and then comes the searching page.
Specialists Search Page![screen](assets/images/30.png)|This picture should be with 29
Specialist Description Page part 1![screen](assets/images/31.png)|Similar page structure as was for general practitioners and hospitals.
Specialist Description Page part 2![screen](assets/images/32.png)|This picture should be with 31
Insurance Page![screen](assets/images/33.png)|Users can see what insurances are available for them and read more by clicking on the logo. If the user wants to learn more about them there is a button provided for “Learn More” which opens the website of the insurance company.
TK Page![screen](assets/images/34.png)|This picture should be with 33
Main Page (others)![screen](assets/images/35.png)|Unfortunately, we were not able to provide more information about banks, housing, education, or local stores. However, we are working on it.
Reminders Page ![screen](assets/images/36.png)|We provide users with a reminders page which will help them remember about their appointments. To add a reminder, the user needs to click on the lower-right button.
Make Reminder Page![screen](assets/images/37.png)|This picture should be with 36
Make Reminder Page (date)![screen](assets/images/38.png)|Users need to choose the doctor, date and time.
Make Reminder Page (time)![screen](assets/images/39.png)|This picture should be with 38
Make Reminder Page (all)![screen](assets/images/40.png)|This picture should be with 38
Profile Page (initial)![screen](assets/images/41.png)|We provide a profile page where the user can edit their profile, read about us and terms and conditions or log out.
Edit profile (part one)![screen](assets/images/42.png)|Users can change their profile photo, name - surname and add their county and date of birth.
Edit profile (part two)![screen](assets/images/43.png)|This picture should be with 42
